...
sudo git clone  https://www.github.com/hirechbaghdad/AEOS-CRM $OE_HOME_EXT/
...
if [ $IS_ENTERPRISE = "True" ]; then
    ...
    GITHUB_RESPONSE=$(sudo git clone --depth 1 --branch 17.0 https://www.github.com/odoo/enterprise "$OE_HOME/enterprise/addons" 2>&1)
